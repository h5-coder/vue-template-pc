module.exports = {
    ...
    /*
     * 梁燕翔
     * 解决 Parsing error: Adjacent JSX elements must be wrapped in an enclosing tag. Did you want a JSX fragment <>...</>? 错误信息
     */
    // parser: 'babel-eslint',
    parserOptions: {
        parser: 'babel-eslint',
    ...
    plugins: ['html', 'flow-vars', 'vue'],
    /*
     下面这些rules是用来设置从插件来的规范代码的规则，使用必须去掉前缀eslint-plugin-
      主要有如下的设置规则，可以设置字符串也可以设置数字，两者效果一致
      "off" -> 0 关闭规则
      "warn" -> 1 开启警告规则，不会导致程序退出
      "error" -> 2 开启错误规则，当被触发的时候，程序会退出
    */
    rules: {
        // 不需要
        ...
        // 错误
        indent: ['error', 4],
        'comma-dangle': [2, 'always-multiline'], // 对象字面量项尾允许有逗号
